...
latex_documents = [(master_doc, "fundem.tex", "Demographic Functions Docs", "Andrew Dolgert", "manual")]
...
man_pages = [(master_doc, "fundem", "Demographic Functions Documentation", [adolgert], 1)]
...
texinfo_documents = [
    (
        master_doc,
        "Fundem",
        "Demographic Functions Documentation",
        author,
        "Fundem",
